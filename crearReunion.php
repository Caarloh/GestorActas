                                            ...
                                            <?php
                                                ...
                                                while ($columna = mysqli_fetch_array( $resultado )){
                                                    ...
                                                    echo '<tr>
                                                        ...
                                                        <td><button type="button" class="btn btn-danger" onclick="'.$usarFuncion.'">Eliminar</button><button type="button" class="btn btn-primary" onclick="'.$accionFuncion.'" data-toggle="modal" data-target="#adminAccion">Administrar Acciones</button></td>
                                                    </tr>';
